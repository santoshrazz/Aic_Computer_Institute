    ...
    return (
        <>
            ...
            <div className="mainCourseDiv grid p-4 grid-cols-1 place-content-center place-items-center md:grid-cols-3">
                ...
                {
                    courseData.map((ele, ind) => (<Card color="gray" variant="gradient" className="w-full m-2 max-w-[20rem] p-8 cursor-pointer " key={ind}>
                        <CardHeader
                            floated={false}
                            shadow={false}
                            color="transparent"
                        ...
                        <CardBody className="p-0">
                            <ul className="flex flex-col gap-4">
                                <li className="flex items-center gap-4">
                                    ...
                                    <Typography className="font-normal">Fundamental of Computer</Typography>
                                </li>
                                <li className="flex items-center gap-4">
                                    <span className="rounded-full border border-white/20 bg-white/20 p-1">
                                        <Check_ICon />
