...
const Check_Certificate = () => {
  ...
  return (
    <div className=" mx-auto rounded-md overflow-x-hidden">
      <Vortex
      ...
      >
        <div className="loginDiv w-full flex gap-4 justify-center  flex-wrap items-center  min-h-screen">
          {/* Toast Container */}
          <ToastContainer />
          ...
          {result && (
            <div className="table">
              <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                  <caption className="p-5 text-lg font-semibold text-left rtl:text-right text-gray-900 bg-white dark:text-white dark:bg-gray-800">
                    ...
                    <p className="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">
                      Type Your Serial number of Your Certificate (Appears at
                ...
                <button
                  className="text-center mx-auto bg-blue-900 text-white w-full hover:bg-yellow-500 p-3"
