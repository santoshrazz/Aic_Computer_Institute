...
const All_Students = () => {
    return (
        ...
        <div className="container mx-auto px-4 sm:px-8">
            <div className="py-8">
                <div>
                    <h2 className="text-2xl font-semibold leading-tight">All Students</h2>
                </div>
                <div className="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                    <div className="inline-block min-w-full shadow-md rounded-lg scroll-auto">
                        <table className="min-w-full leading-normal scroll-auto">
                            <thead>
                                <tr>
                                    <th
                                        className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-extrabold text-gray-700 uppercase tracking-wider">
                                        Students / Invoice
                                    </th>
                                    <th
                                        className="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-extrabold text-gray-700 uppercase tracking-wider">
                                    ...
                                    <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <div className="flex">
                                            ...
                                            <div className="ml-3">
                                                ...
                                                <p className="text-gray-600 whitespace-no-wrap">Vikrant Yadav</p>
                                            </div>
                                        </div>
                                    </td>
                                    <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
